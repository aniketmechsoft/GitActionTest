...
//		sAssert.assertEquals(cp.captureToastMessage(), "Pallet deleted successfully.", "not matched");
//		sAssert.assertAll();
//
//	}
//
...
//	public void shouldCreatePalletAndCheckboxesRemainSelectedAfterChangingPagination() throws TimeoutException, InterruptedException {
//		SoftAssert sAssert = new SoftAssert();
//		ip.inboundMenu();
//		initialCount = ip.getTotalEntriesCount(driver);
//		ip.createPallet();
...
//	}
//
//	@Test(priority = 8, dependsOnMethods = "shouldCreatePalletAndCheckboxesRemainSelectedAfterChangingPagination")
...
//	}
//
//	@Test(priority = 15, dataProvider = "getData", groups = "Smoke", enabled = false)
...
//	}
//
//	@Test(priority = 19, groups = "Smoke", enabled = false)
...
//	@AfterClass()
//	public void shouldCheckOrderStatusAfterInoundPalletCreate() {
//		SoftAssert sAssert = new SoftAssert();
//		cp.orderpageMenulanding();
//		sAssert.assertEquals(it.getOrderStatus(op.getMGLOrderno()),
//				ReadJsonData.getNestedValue("ILoadPending", "expected"),
